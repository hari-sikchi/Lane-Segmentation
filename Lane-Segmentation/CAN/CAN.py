...
class CAN(nn.Module):
    ...
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            # nn.Conv2d(19, 19, kernel_size=3, stride=1, padding=1, bias=True), #ctx_conv
            # nn.ReLU(inplace=True),
            # nn.ZeroPad2d(1),
            ...
            # nn.ZeroPad2d(2),
            # nn.Conv2d(19, 19, kernel_size=3, stride=1, padding=1, bias=True, dilation=2),
            # nn.ReLU(inplace=True),
           
            # nn.ZeroPad2d(4),
            # nn.Conv2d(19, 19, kernel_size=3, stride=1, padding=1, bias=True, dilation=4),
            # nn.ReLU(inplace=True),
            
            # nn.ZeroPad2d(8),
            # nn.Conv2d(19, 19, kernel_size=3, stride=1, padding=1, bias=True, dilation=8),
            # nn.ReLU(inplace=True),
            
            # nn.ZeroPad2d(16),
            # nn.Conv2d(19, 19, kernel_size=3, stride=1, padding=1, bias=True, dilation=16),
            # nn.ReLU(inplace=True),
            
            # nn.ZeroPad2d(32),
            # nn.Conv2d(19, 19, kernel_size=3, stride=1, padding=1, bias=True, dilation=32),
            # nn.ReLU(inplace=True),
