...
def train_dcgan():
    ...
    for EPOCHS in range(100):
        ...
        for i, data in enumerate(trainloader):
            ...
            if flippos:
                real_label = real_label + random.uniform(0,0.2)
                fake_label = fake_label + random.uniform(-0.2, 0)
            else:
                fake_label = fake_label + random.uniform(0,0.2)
                real_label = real_label + random.uniform(-0.2, 0)
