...
net = FCN_Dilated()
net.load_state_dict(torch.load('trained.wts', map_location=lambda storage, location: storage))
net.to(device)

dst = kittiLoader('/home/deeplearning/work/Tejus/data_road/', split="val")
valloader = data.DataLoader(dst, batch_size=1, shuffle=True, num_workers=1, pin_memory=False)
