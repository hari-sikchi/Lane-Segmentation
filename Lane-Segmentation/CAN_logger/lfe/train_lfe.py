...
from CAN_LFE.CAN_lfe import CAN
...
checkpoint_dir = '/home/tejus/lane-seg-experiments/Segmentation/CAN_logger/lfe/runs/1/best_val_model_tested.pkl'
...
if not resume_training:
    ...
    pretrained_state_dict = checkpoint["model_state"].state_dict()
    pretrained_state_dict['features.74.weight'] = pretrained_state_dict.pop('features.34.weight')
    pretrained_state_dict['features.74.bias'] = pretrained_state_dict.pop('features.34.bias')
    net.load(pretrained_state_dict, strict=False)
