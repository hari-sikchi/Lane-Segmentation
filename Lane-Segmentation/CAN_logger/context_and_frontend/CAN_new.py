...
class CAN(nn.Module):
    ...
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            nn.Conv2d(4096, 2*11*11, kernel_size=1, stride=1, padding=0, bias=True), #final layer
            nn.ReLU(inplace=True),
            ...
            # nn.Conv2d(2, 2, kernel_size=3, stride=1, padding=(0,1), bias=True, dilation=(1,2)), #ctx_conv
            # nn.ReLU(inplace=True),
            # nn.ZeroPad2d(1),
